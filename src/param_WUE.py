...
# queryDef = db.CreateQueryDef("", "SELECT distinct fullpath, archivename,filename FROM DownloadedZipFiles WHERE filename='ClimAf_1_1960-2100_lpjg_can_wfdei_qmbc_B1_yield_sea_trpe_rf.nc.gz';")
