...
arcpy.PolygonToRaster_conversion(speciesFL,"ID_NO", outputFile, "MAXIMUM_AREA", PRIORITY_FIELDNAME,"1222.9924525618553") # 1222.9924525618553 is the grid size for zoom level 15 in Web Mercator